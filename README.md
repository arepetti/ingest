...
| A **developer / contributor**                     | Clean-architecture-ish layering, full XML doc comments, a small PoC test suite, and Aspire-driven local dev.                                | [CONTRIBUTING.md](CONTRIBUTING.md) and [docs/architecture/](docs/architecture/README.md)                                                     |
