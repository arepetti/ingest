...
- Expression editor in the schema editor: CodeMirror-based syntax highlighting, autocomplete, and error squiggles.
...
- **Draft submissions** (with notifications).
- Clone a submission into a new submission.
...
- **Admin SPA** for managing services, schemas, and submissions, with per-service status tracking.
