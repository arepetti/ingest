...
| [performance.md](performance.md)      | Expected workload, throughput, and response times for a typical mid-sized deployment on the standard Azure hosting setup — data volume, QPS, latencies, and when to revisit sizing. |
