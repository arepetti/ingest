...
>
> **The primary way to explore the data is PowerBI (or any similar BI/OData client) pointed at the OData feed** — see [setup/powerbi/](../setup/powerbi/README.md). That's where filtering, slicing, charts, and large datasets belong. Reach for reports only when you specifically want a small, canned, server-rendered page; reach for PowerBI for everything else.
