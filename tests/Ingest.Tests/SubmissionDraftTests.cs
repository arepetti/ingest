...
public class SubmissionDraftTests
{
    ...
    {
        public Task<SubmissionValidationResult> ValidateAsync(Account service, Submission submission, bool isReplacement, Submission? existing, bool draft = false, CancellationToken ct = default) =>
